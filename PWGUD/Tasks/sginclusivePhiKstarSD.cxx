    ...
    */
    ...
    if (fourpion) {
      if (gapSide == BothSides && mult2 == numFourTracks) {
        ...
        if ((int)onlyPionTracksp.size() == numTwoTracks && (int)onlyPionTracksn.size() == numTwoTracks) {
        ...
        if (onlyPionTracksp.size() != numTwoTracks && onlyPionTracksn.size() != numTwoTracks) {
          if (onlyPionTracksp.size() + onlyPionTracksn.size() != numFourTracks)
            return;
